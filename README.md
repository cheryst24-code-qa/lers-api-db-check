## 🚩 Сверка API и DB (ЛЭРС)

Автоматизированный скрипт для проверки согласованности данных между REST API и базой данных MS SQL Server системы "ЛЭРС УЧЁТ".
